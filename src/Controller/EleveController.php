...
class EleveController extends AbstractController
{
    ...
    public function new(Request $request, EleveRepository $eleveRepository, MailerController $mailer): Response
    {
        $eleve = new Eleve();
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('app_eleve_email', [], Response::HTTP_SEE_OTHER);
        }
